	...
	return (
		<>
			...
			<section className="w-10/12 sm:w-8/12 md:w-5/12 lg:w-5/12 xl:w-4/12 space-y-5 flex flex-col text-center ">
				<h1 className="text-2xl font-Mont font-semibold">CURRENT EVENT</h1>
				<div className="items-center justify-center border-2 rounded-xl ">
					...
					<p className="px-4 py-4">
						...
						Aliquam cursus auctor ex ut dictum. In bibendum quis mi nec scelerisque. Vivamus at nibh eu eratrhoncus tempor.
					</p>
				</div>
			</section>
		</>
