	...
	return (
		<>
			<div className="flex items-center justify-center w-full">
				<button
					className="w-full py-1 border-2 border-[#08F294] text-[#08F294] text-large bg-black font-Roboto hover:bg-[#08F294] hover:text-black hover:font-bold"
					type="button"
								...
								<div className="mt-3">
									<div className="mt-2 mb-5 flex flex-col items-center ">
										...
										<p className="text-[#42805F] pb-2 pt-3 text-center font-Roboto max-w-sm">
											Insert a wallet address in order to add them to the split. Check under
